...
# Alternativa: Usar los datos originales sin SMOTE
X_train_res, y_train_res = X_train, y_train

# Parámetros modificados para LightGBM con ajuste de pesos para manejar desbalance
params = {
    'objective': 'binary',
    ...
    'is_unbalance': True  # Manejar el desbalance ajustando los pesos de las clases
}
