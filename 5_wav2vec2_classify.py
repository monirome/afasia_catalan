...
# Funcion para extraer la capa 6 de Wav2Vec 2.0
...
# Extraer caracteristicas con la capa 6 de Wav2Vec 2.0
train_features = []
test_features = []
...
# Convertir las listas de caracteristicas en DataFrames
...
# Convertir la variable objetivo (Fluente/No Fluente) a formato numerico
le = LabelEncoder()
...
# Concatenar las caracteristicas extraidas de los audios con el resto del dataset
...
# Parametros modificados para LightGBM
params = {
    'objective': 'binary',
